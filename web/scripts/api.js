class ComfyApi extends EventTarget {
        ...
        if (event.data instanceof ArrayBuffer) {
          ...
          switch (eventType) {
            case 1:
              ...
              this.dispatchEvent(new CustomEvent("b_preview", {
                detail: imageBlob
              }));
              break;
            default:
          ...
          switch (msg.type) {
            ...
            case "progress":
              ...
              break;
            case "executing":
              this.dispatchEvent(new CustomEvent("executing", {
                detail: msg.data.node
              }));
              break;
            case "executed":
            ...
            case "execution_start":
              this.dispatchEvent(new CustomEvent("execution_start", {
                detail: msg.data
              }));
              break;
            ...
            case "execution_cached":
              this.dispatchEvent(new CustomEvent("execution_cached", {
                detail: msg.data
              }));
              break;
            default:
  ...
  async getHistory(max_items = 200) {
    try {
      ...
      return {
        History: Object.values(await res.json())
      };
    } catch (error) {
      console.error(error);
      return {
   ...
   */
  async moveUserData(source, dest, options = {
    overwrite: false
  }) {
