...
extends IWidget < boolean, {
  on ? : string;off ? : string
} > {
  type: "toggle";
}
export interface ISliderWidget
extends IWidget < number, {
...
export const LiteGraph: {
  ...
  registered_node_types: Record < string,
  ...
  registerNodeType(type: string, base: {
    new(): LGraphNode
  }): void;
...
export declare class LGraphNode {
  ...
  getInputInfo(
    ...
    link: number;name: string;type: string | 0
  } | null;
  ...
  getOutputInfo(
    ...
    name: string;type: string;links: number[]
  } | null;
...
export declare class LGraphCanvas {
  ...
  createDialog(
    html: string,
    options ? : {
      position ? : Vector2;event ? : MouseEvent
    }
  ): void;
